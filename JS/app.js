...
const DetailsNews = newses => {
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <div class="ms-4">
          <h5>${news.total_view ? news.total_view : 'No Viewers'}</h5>
          </div>
        </div>
    ...
    <div>
    <button onclick="displayNewsDetails('${news._id}')" type="button" class="btn btn-info mx-auto mt-3 py-2 px-2" data-bs-toggle="modal" data-bs-target="#exampleModal">See Details</button>
